...
class States_list extends Cit_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('states_list_model');
     ...
     */
    public function rules_states_list($request_arr = array())
    {
        $valid_arr = array();
     ...
     */
    public function start_states_list($request_arr = array(), $inner_api = FALSE)
    {
        try
        {
            $validation_res = $this->rules_states_list($request_arr);
            ...
            $input_params = $this->get_states_list_v1($input_params);
     ...
     */
    public function get_states_list_v1($input_params = array())
    {
        ...
        try
        {
            ...
            $STATES_LIST_COUNTRY_ID = $this->config->item("STATES_LIST_COUNTRY_ID");
            $STATES_LIST_COUNTRY_CODE = $this->config->item("STATES_LIST_COUNTRY_CODE");
            $this->block_result = $this->state_model->get_states_list_v1($STATES_LIST_COUNTRY_ID, $STATES_LIST_COUNTRY_CODE);
        ...
        $input_params["get_states_list_v1"] = $this->block_result["data"];
    ...
    public function condition($input_params = array())
    {
        ...
        try
        {
            ...
            $cc_lo_0 = (empty($input_params["get_states_list_v1"]) ? 0 : 1);
            $cc_ro_0 = 1;
    ...
    public function mod_state_finish_success($input_params = array())
    {
        ...
        $ouput_aliases = array(
            "get_states_list_v1" => "get_state_list",
            "ms_state" => "state",
            "ms_state_id" => "state_id",
            "ms_state_code" => "state_code",
            "ms_status" => "status",
            "ms_country_code" => "country_code",
        );
