...
class Report_abusive_user extends Cit_Controller
{
    ...
    */
     ...
     */
    public function rules_report_abusive_business($request_arr = array())
    {
        $valid_arr = array(
            "user_id" => array(
                array(
     ...
     */
    public function start_report_abusive_business($request_arr = array(), $inner_api = FALSE)
    {

        try
        {
            $validation_res = $this->rules_report_abusive_business($request_arr);
