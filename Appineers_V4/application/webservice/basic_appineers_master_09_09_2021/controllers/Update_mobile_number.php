 ...
 *
 */
class Update_mobile_number extends Cit_Controller
{
     ...
     */
    public function rules_update_mobile_number($request_arr = array())
    {
        $valid_arr = array(
            "type" => array(
                array(
        ...
        $valid_res = $this->wsresponse->validateInputParams($valid_arr, $request_arr, "update_mobile_number");
     ...
     */
    public function start_update_mobile_number($request_arr = array(), $inner_api = FALSE)
    {
        try {
            $validation_res = $this->rules_update_mobile_number($request_arr);
    ...
    public function update_mobile_number($input_params = array())
    {
        ...
        try {
            ...
            $this->block_result = $this->users_model->update_mobile_number_deatils($params_arr, $where_arr);
        } catch (Exception $e) {
            $this->general->apiLogger($input_params, $e);
            $success = 0;
