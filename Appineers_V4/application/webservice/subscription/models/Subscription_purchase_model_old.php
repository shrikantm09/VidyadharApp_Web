...
class Subscription_purchase_model extends CI_Model
{
     ...
     * @created CIT Dev Team
     * @modified Suresh nakate | 03.03.2021
     * @param array $params_arr params_arr array to process query block.
     * @param array $where_arr where_arr are used to process where condition(s).
     * @return array $return_arr returns response of query block.
     */
    ...
    /**
     * update_subscription_purchase_android method is used to execute database queries for Subscription Purchase API.
     * @created CIT Dev Team
     * @modified Suresh nakate | 03.03.2021
     * @param array $params_arr params_arr array to process query block.
     * @param array $where_arr where_arr are used to process where condition(s).
    ...
    public function get_user_android_subscription_details($user_id,$purchase_token)
    {
         try
        {
            ...
            $this->db->select('lReceiptData as purchase_token,vProductId as product_id,"1" as subscription_status');
