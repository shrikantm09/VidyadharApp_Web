...
class Social_sign_up extends Cit_Controller
{
    ...
    public function start_social_sign_up($request_arr = array(), $inner_api = FALSE)
    {
        ...
        try {
            ...
            if($input_params["check_unique_user"]["status"] === '1'){
                $input_params = $this->create_user_social($input_params);
            }

            if($input_params["check_unique_user"]["status"] === '2'){
                $input_params = $this->update_existing_account($input_params);
            }
    ...
    public function check_login_status($input_params = array())
    {
        $this->block_result = array();
        try {
            $cc_lo_0 = !empty($input_params["get_user_details_v1_v1"]) ? 1 : 0;
            $cc_ro_0 = 1;
    ...
    public function social_login_finish_success($input_params = array())
    {
        ...
        $ouput_aliases = array(
            "get_user_details_v1_v1" => "get_user_details_v1_v1",
    ...
    {
        $msg = isset($input_params['message']) ? $input_params['message'] : "finish_success_1";
