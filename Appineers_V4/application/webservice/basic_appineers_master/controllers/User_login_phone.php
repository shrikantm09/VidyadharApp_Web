...
class User_login_phone extends Cit_Controller
{
    ...
    public function start_user_login_phone($request_arr = array(), $inner_api = FALSE)
    {
        try {
            ...
            if ($input_params["status"]) {
                ...
                if ($input_params['get_user_login_details_v1']['success']) {
                    ...
                    if ($condition_res["success"]) {
                        ...
                        if ($input_params['update_device_details_v1']["success"]) {
    ...
    public function get_user_login_details_v1($input_params = array())
    {
        ...
        $input_params["get_user_login_details_v1"]["success"] = $this->block_result["success"];
    ...
    public function update_device_details_v1($input_params = array())
    {
        ...
        $input_params["update_device_details_v1"] = $this->block_result;
        $input_params = $this->wsresponse->assignSingleRecord($input_params, $this->block_result["data"]);
