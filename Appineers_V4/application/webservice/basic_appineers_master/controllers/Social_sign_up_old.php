...
class Social_sign_up extends Cit_Controller
{
    ...
    public function start_social_sign_up($request_arr = array(), $inner_api = FALSE)
    {
        ...
        try {
            ...
            $input_params = $input_params["check_unique_user"]["status"] === '1' ? $this->create_user_social($input_params) :  $input_params;
            ...
            if ($condition_res["success"]) {
                   ...
                   if($input_params["check_unique_user"]["status"] === '0' ){

                    $output_response = $this->users_signup_finish_success($input_params);
     ...
     */
    public function users_signup_finish_success($input_params = array())
    {
     ...
     * @return array $responce_arr returns responce array of api.
     */
    public function users_signup_finish_success_1($input_params = array())
    {

        $setting_fields = array(
            "success" => FAILED_CODE,
            "message" => "users_signup_finish_success_1",
        );
        $output_fields = array();
