...
class User_login_email extends Cit_Controller
{
    ...
    /**
     * This method used to validate api input params.
     * 
    ...
    public function start_user_login_email($request_arr = array(), $inner_api = FALSE)
    {
        try {
            ...
            if ($input_params["status"]) {
                ...
                if ($input_params['get_user_login_details']['success']) {
                    ...
                    if ($condition_res["success"]) {
                        ...
                        if ($input_params['update_device_details']["success"]) {
                ...
                if($input_params['not_found']){


                $output_response = $this->finish_not_found_success($input_params);
                return $output_response;
    ...
    /**
     * This method is used to prepare where condition.
     * 
    ...
    public function get_user_login_details($input_params = array())
    {
        ...
        $input_params["get_user_login_details"]["success"] = $this->block_result["success"];
     ...
     * 
     * @return array $result_arr returns result of condition block as array.
     */
    ...
    /**
     * This method is used to check login status.
     * 
     * @param array $input_params  array to process condition flow.
     * 
    ...
    public function check_login_status($input_params = array())
    {
        ...
        try {
            ...
            if (!$cc_fr_0) {
                throw new Exception("User status is active.");
            }
            ...
            if (!$cc_fr_1) {
                throw new Exception("User email is verified.");
            }
            $success = 1;
    ...
    /**
     * This method is used to update device details.
     * 
     * @param array $input_params  array to process loop flow.
     * 
     * @return array $input_params returns modified input_params array.
    ...
    public function update_device_details($input_params = array())
    {
        ...
        $input_params["update_device_details"] = $this->block_result;
        $input_params = $this->wsresponse->assignSingleRecord($input_params, $this->block_result["data"]);
    ...
    public function users_finish_success_3($input_params = array())
    {
        ...
        $ouput_aliases = array(
            ...
            "u_is_mobile_number_verified" => "is_mobile_number_verified",
    ...
    /**
     * This method is used to is archieved.
     * 
    ...
    public function is_archieved($input_params = array())
    {
        ...
        try {
            ...
            $cc_fr_0 = ($cc_lo_0 == $cc_ro_0) ? TRUE : FALSE;
            if (!$cc_fr_0) {
                throw new Exception("User status is archived.");
            }
            $success = 1;
            $message = "Conditions matched.";
        } catch (Exception $e) {
    ...
    /**
     * This method is used to is email confirmed.
     * 
     * @param array $input_params input_params array to process condition flow.
     * 
     * @return array $block_result returns result of condition block as array.
     ...
     * @return array $responce_arr returns responce array of api.
     */
    public function finish_not_found_success($input_params = array())
    {

        $setting_fields = array(
            "success" => FAILED_CODE,
            "message" => "finish_not_found_success",
        );
        $output_fields = array();
