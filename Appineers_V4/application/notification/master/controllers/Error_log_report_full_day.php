 ...
 *
 * @class Error_log_report_full_day.php
 *
 * @path application\notifications\user\controllers\Error_log_report_full_day.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Error_log_report_full_day extends Cit_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('error_log_report_full_day_model');
    }
     ...
     */
    public function start_error_log_report_full_day($request_arr = array())
    {
        try {
            ...
            if (!empty($input_params['log_records']['data'])) {
                if (count($input_params['log_records']['data']) > 0) {
                ...
                $input_params = $this->delete_error_logs(); //deletes access logs for days defined in config
    ...
    public function get_error_logs($input_params = array())
    {
        $this->block_result = array();
        try {
            $this->block_result = $this->error_log_report_full_day_model->get_fullday_error_logs();
    ...
    */
    public function delete_error_logs()
    {
        ...
        try {
            $this->block_result = $this->error_log_report_full_day_model->delete_error_logs();
    ...
    */
    public function email_notification($input_params = array())
    {
        $this->block_result = array();
        try {
            $email_arr["error_count"] = $input_params['errorCount'];

            $email_arr["error_from"] = $input_params['Date'];
    ...
    /**
     * finish_success method is used to process finish sucess flow.
     *
     * @param array $input_params input_params array to process loop flow.
     *
    ...
    /**
     * This method is used to process finish failure flow.
     *
     * @param array $input_params input_params array to process loop flow.
     *
     * @return array $responce_arr returns responce array of api.
