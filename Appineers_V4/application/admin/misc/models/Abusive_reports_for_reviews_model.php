...
class Abusive_reports_for_reviews_model extends CI_Model 
{
    ...
    public function __construct() 
    {
        ...
        $this->table_name = "abusive_reports_for_reviews";
        $this->table_alias = "arfp";
        $this->primary_key = "iAbusiveReportsForReviewId";
        ...
        $this->orderby_cond = array(
                    array(
                        "field" => "arfp.iAbusiveReportsForReviewId",
                        "order" => "DESC"
                    ));
        $this->unique_type = "OR";
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        $this->db->select("r.vDescription AS p_post_title");
        ...
        $this->db->select("arfp.iReviewId AS arfp_review_id");
        $this->db->select("u.iUserId AS ron_users_id");
            $this->db->select("owner.iUserId AS rb_users_id");
        
        } else {
            $this->db->select("arfp.iAbusiveReportsForReviewId AS iAbusiveReportsForReviewId");
            $this->db->select("arfp.iAbusiveReportsForReviewId AS arfp_abusive_reports_for_review_id");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
                ...
                "align" => "left",
                "label" => "Reported By",
                "lang_code" => "ABUSIVE_REPORTS_FOR_REVIEWS_REPORTED_BY",
                "label_lang" => $this->lang->line('ABUSIVE_REPORTS_FOR_REVIEWS_REPORTED_BY'),
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                "addable" => "No",
              ...
              "owner_first_name" => array(
                ...
                "align" => "left",
                "label" => "Review Owner",
                "lang_code" => "ABUSIVE_REPORTS_FOR_REVIEWS_OWNER",
                "label_lang" => $this->lang->line('ABUSIVE_REPORTS_FOR_REVIEWS_OWNER'),
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                "addable" => "No",
                ...
                "table_name" => "review",
                "table_alias" => "r",
                "field_name" => "vDescription",
                "source_field" => "",
                "display_query" => "r.vDescription",
                "entry_type" => "Table",
                "data_type" => "",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Review Title",
                 "lang_code" => "ABUSIVE_REPORTS_FOR_REVIEWS_REVIEW_TITLE",
                "label_lang" => $this->lang->line('ABUSIVE_REPORTS_FOR_REVIEWS_REVIEW_TITLE'),
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                "addable" => "No",
                ...
                "arfp_message" => array(
                "name" => "arfp_message",
                "table_name" => "abusive_reports_for_reviews",
                "table_alias" => "arfp",
                "field_name" => "vMessage",
                ...
                "align" => "left",
                "label" => "Message",
                "lang_code" => "ABUSIVE_REPORTS_FOR_REVIEWS_MESSAGE",
                "label_lang" => $this->lang->line('ABUSIVE_REPORTS_FOR_REVIEWS_MESSAGE'),
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                "addable" => "No",
                ...
                "align" => "left",
                "label" => "Reported On",
                "lang_code" => "ABUSIVE_REPORTS_FOR_REVIEWS_REPORTED_ON",
                "label_lang" => $this->lang->line('ABUSIVE_REPORTS_FOR_REVIEWS_REPORTED_ON'),
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                "addable" => "No",
            ...
            "status" => array(
                ...
                "align" => "center",
                "label" => "Status",
                "lang_code" => "ABUSIVE_REPORTS_FOR_REVIEWS_STATUS",
                "label_lang" => $this->lang->line('ABUSIVE_REPORTS_FOR_REVIEWS_STATUS'),
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                "addable" => "No",
             ...
             "sys_custom_field_1" => array(
                ...
                "align" => "center",
                "label" => "Edit",
                "lang_code" => "ABUSIVE_REPORTS_FOR_REVIEWS_EDIT",
                "label_lang" => "Edit",
                "search" => "No",
                "export" => "No",
                "sortable" => "Yes",
        ...
        $form_config = array(
             ...
             "owner_first_name" => array(
              ...
              "p_post_title" => array(
                ...
                "type" => "textbox",
                "label" => "Post",
                "lang_code" => "ABUSIVE_REPORTS_FOR_REVIEWS_REVIEW",
                "label_lang" => $this->lang->line('ABUSIVE_REPORTS_FOR_REVIEWS_REVIEW')
    ...
    public function processCustomLinks($data_arr = array(), $config_arr = array())
    {
        ...
        foreach($listing_data as $dKey => $dVal){
            ...
            $id = $dVal["iAbusiveReportsForReviewId"];
