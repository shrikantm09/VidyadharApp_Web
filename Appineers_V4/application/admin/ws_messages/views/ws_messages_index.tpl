...
<div class="module-list-container">
    <%include file="ws_messages_index_strip.tpl"%>
    <!-- Group & Grand Summary Block -->
...
<%javascript%>
    ...
    {
        "name": "mwm_code",
        "label": "<%$list_config['mwm_code']['label_lang']%>"
    },
    {
        "name": "mwml_message",
    ...
    js_col_model_json = [{
        ...
        "export": <%if $list_config['mwm_apiname']['export'] eq 'No' %>false<%else%>true<%/if%>,
        ...
        "hideme": <%if $list_config['mwm_apiname']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        ...
        "editrules": {
            ...
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.WS_MESSAGES_API_NAME)
                }
            }
        },
        "searchoptions": {
    ...
    },
    {
        ...
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['mwm_code']['width']%>",
        "search": <%if $list_config['mwm_code']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['mwm_code']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['mwm_code']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['mwm_code']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['mwm_code']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['mwm_code']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['mwm_code']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "required": true,
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.WS_MESSAGES_CODE)
                }
            }
        },
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "ws_messages",
                "aria-unique-name": "mwm_code",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['mwm_code']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "ws_messages",
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['mwm_code']['default']%>",
        "filterSopt": "bw",
    ...
    },
    {
        ...
        "export": <%if $list_config['mwml_message']['export'] eq 'No' %>false<%else%>true<%/if%>,
        ...
        "hideme": <%if $list_config['mwml_message']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
    ...
    },
    {
        ...
        "export": <%if $list_config['mwm_type']['export'] eq 'No' %>false<%else%>true<%/if%>,
        ...
        "hideme": <%if $list_config['mwm_type']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        ...
        "editrules": {
            ...
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.WS_MESSAGES_TYPE)
                }
            }
        },
        "searchoptions": {
            ...
            "dataUrl": <%if $count_arr["mwm_type"]["json"] eq "Yes" %>false<%else%>'<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mwm_type&mode=<%$mod_enc_mode["Search"]%>&rformat=html<%$extra_qstr%>'<%/if%>,
            "value": <%if $count_arr["mwm_type"]["json"] eq "Yes" %>$.parseJSON('<%$count_arr["mwm_type"]["data"]|@addslashes%>')<%else%>null<%/if%>,
            "dataInit": <%if $count_arr['mwm_type']['ajax'] eq 'Yes' %>initSearchGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mwm_type"]["ajax"] eq "Yes" %>ajax-call<%/if%>',
            "multiple": true
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "ws_messages",
            "aria-unique-name": "mwm_type",
            "dataUrl": '<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mwm_type&mode=<%$mod_enc_mode["Update"]%>&rformat=html<%$extra_qstr%>',
            "dataInit": <%if $count_arr['mwm_type']['ajax'] eq 'Yes' %>initEditGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mwm_type"] eq "Yes" %>ajax-call<%/if%>',
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'WS_MESSAGES_TYPE')%>",
    ...
    },
    {
        ...
        "export": <%if $list_config['mwm_status']['export'] eq 'No' %>false<%else%>true<%/if%>,
        ...
        "hideme": <%if $list_config['mwm_status']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        ...
        "editrules": {
            ...
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.WS_MESSAGES_STATUS)
                }
            }
        },
        "searchoptions": {
