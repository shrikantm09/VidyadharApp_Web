...
class Pushnotifications_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->grid_fields = array("u_sender_email",
            "u_receiver_email",
            "mpn_device_id",
            "mpn_title",
            "mpn_message",
        ...
        $this->join_tables = array(
            array(
                ...
                "table_alias" => "u",
                "field_name" => "iUserId",
                "rel_table_name" => "mod_push_notifications",
                "rel_table_alias" => "mpn",
                "rel_field_name" => "iSenderId",
                "join_type" => "left",
                "extra_condition" => ""
            ),
            array(
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            if ($this->primary_alias != "")
            {
             ...
             $this->db->select("u.vEmail AS u_sender_email"); 
               $this->db->select("us.vEmail AS u_receiver_email");   
            ...
            $this->db->select("mpn.tError AS failure_reason");
        }
        else
        {
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array( 
              "u_sender_email" => array(
                ...
                "align" => "left",
                "label" => "Email",
                "lang_code" => "PUSHNOTIFICATIONS_SENDER_EMAIL",
                "label_lang" => $this->lang->line('PUSHNOTIFICATIONS_SENDER_EMAIL'),
                "width" => 200,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "u_receiver_email" => array(
                ...
                "align" => "left",
                "label" => "Email",
                "lang_code" => "PUSHNOTIFICATIONS_RECEIVER_EMAIL",
                "label_lang" => $this->lang->line('PUSHNOTIFICATIONS_RECEIVER_EMAIL'),
                "width" => 200,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "failure_reason" => array(
                ...
                "table_alias" => "mpn",
                "field_name" => "tError",
                "source_field" => "failure_reason",
                "display_query" => "mpn.tError",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Title",
                "label_lang" => $this->lang->line('PUSHNOTIFICATIONS_FAILURE_RESON'),
                "width" => 150,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
