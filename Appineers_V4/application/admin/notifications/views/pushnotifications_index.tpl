...
<%javascript%>
    ...
    js_col_name_json = [{
        "name": "u_sender_email",
        "label": "<%$list_config['u_sender_email']['label_lang']%>"
    },
    {
        "name": "u_receiver_email",
        "label": "<%$list_config['u_receiver_email']['label_lang']%>"
    },
    {
        "name": "mpn_device_id",
    ...
    },
    {
     ...
     {
        "name": "failure_reason",
        "label": "<%$list_config['failure_reason']['label_lang']%>"
    },
    {
        "name": "mpn_status",
    ...
    js_col_model_json = [{
        "name": "u_sender_email",
        "index": "u_sender_email",
        "label": "<%$list_config['u_sender_email']['label_lang']%>",
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['u_sender_email']['width']%>",
        "search": <%if $list_config['u_sender_email']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['u_sender_email']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['u_sender_email']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['u_sender_email']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['u_sender_email']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['u_sender_email']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['u_sender_email']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "select",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            ...
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['u_sender_email']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "api_access_logs",
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['u_sender_email']['default']%>",
        "filterSopt": "bw"
    },
    {
        "name": "u_receiver_email",
        "index": "u_receiver_email",
        "label": "<%$list_config['u_receiver_email']['label_lang']%>",
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['u_receiver_email']['width']%>",
        "search": <%if $list_config['u_receiver_email']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['u_receiver_email']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['u_receiver_email']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['u_receiver_email']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['u_receiver_email']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['u_receiver_email']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['u_receiver_email']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "select",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            ...
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['u_receiver_email']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "api_access_logs",
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['u_receiver_email']['default']%>",
        "filterSopt": "bw"
    },
    {
        "name": "mpn_device_id",
...

    {
        ...
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['failure_reason']['width']%>",
        "search": <%if $list_config['failure_reason']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['failure_reason']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['failure_reason']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['failure_reason']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['failure_reason']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['failure_reason']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['failure_reason']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "pushnotifications",
                "aria-unique-name": "failure_reason",
                "autocomplete": "off",
                "class": "search-inline-date",
                "aria-date-format": "YYYY-MM-DD"
            },
            "sopt": dateSearchOpts,
            "searchhidden": <%if $list_config['failure_reason']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
            "dataInit": initSearchGridDateRangePicker
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
