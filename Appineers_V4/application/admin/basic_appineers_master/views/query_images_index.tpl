...
<div class="module-list-container">
    <%include file="query_images_index_strip.tpl"%>
...
<%javascript%>
    ...
    el_grid_settings['default_sort'] = 'uqi_user_query_id';
    ...
    js_col_name_json = [{
        ...
        "label": "<%$list_config['uqi_user_query_id']['label_lang']%>"
    },
    {
        "name": "uqi_query_image",
        "label": "<%$list_config['uqi_query_image']['label_lang']%>"
    },
    {
        "name": "uqi_added_at",
    ...
    js_col_model_json = [{
        "name": "uqi_user_query_id",
        "index": "uqi_user_query_id",
        "label": "<%$list_config['uqi_user_query_id']['label_lang']%>",
        "labelClass": "header-align-center",
        "resizable": true,
        "width": "<%$list_config['uqi_user_query_id']['width']%>",
        "search": <%if $list_config['uqi_user_query_id']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['uqi_user_query_id']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['uqi_user_query_id']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['uqi_user_query_id']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['uqi_user_query_id']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['uqi_user_query_id']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['uqi_user_query_id']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "center",
        "edittype": "select",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            "attr": {
                ...
                "aria-module-name": "query_images",
                "aria-unique-name": "uqi_user_query_id",
                "autocomplete": "off",
                "data-placeholder": " ",
            ...
            "sopt": intSearchOpts,
            "searchhidden": <%if $list_config['uqi_user_query_id']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
            "dataUrl": <%if $count_arr["uqi_user_query_id"]["json"] eq "Yes" %>false<%else%>'<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=uqi_user_query_id&mode=<%$mod_enc_mode["Search"]%>&rformat=html<%$extra_qstr%>'<%/if%>,
            "value": <%if $count_arr["uqi_user_query_id"]["json"] eq "Yes" %>$.parseJSON('<%$count_arr["uqi_user_query_id"]["data"]|@addslashes%>')<%else%>null<%/if%>,
            "dataInit": <%if $count_arr['uqi_user_query_id']['ajax'] eq 'Yes' %>initSearchGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["uqi_user_query_id"]["ajax"] eq "Yes" %>ajax-call<%/if%>',
            "multiple": true
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "query_images",
            "aria-unique-name": "uqi_user_query_id",
            "dataUrl": '<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=uqi_user_query_id&mode=<%$mod_enc_mode["Update"]%>&rformat=html<%$extra_qstr%>',
            "dataInit": <%if $count_arr['uqi_user_query_id']['ajax'] eq 'Yes' %>initEditGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["uqi_user_query_id"] eq "Yes" %>ajax-call<%/if%>',
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'QUERY_IMAGES_USER_QUERY_ID')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
        "default_value": "<%$list_config['uqi_user_query_id']['default']%>",
        "filterSopt": "in",
        "stype": "select"
    },
    {
        "name": "uqi_query_image",
        "index": "uqi_query_image",
        "label": "<%$list_config['uqi_query_image']['label_lang']%>",
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['uqi_query_image']['width']%>",
        "search": false,
        "export": <%if $list_config['uqi_query_image']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['uqi_query_image']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['uqi_query_image']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['uqi_query_image']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['uqi_query_image']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['uqi_query_image']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "file",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "query_images",
                "aria-unique-name": "uqi_query_image",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['uqi_query_image']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "query_images",
        ...
        "ctrl_type": "file",
        "default_value": "<%$list_config['uqi_query_image']['default']%>",
        "filterSopt": "cn"
    },
    {
        "name": "uqi_added_at",
    ...
    },
    {
        ...
        "editoptions": {
            ...
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'QUERY_IMAGES_STATUS')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
