...
/**
 * Description of System SMS Model
 *
 * @category admin
 *
 ...
 *
 * @path application\admin\basic_appineers_master\models\Sms_template_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Sms_template_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->table_alias = "st";
        $this->primary_key = "iSmsTemplateId";
        $this->primary_alias = "st_sms_template_id";
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("st.vTemplateCode AS st_template_code");
            $this->db->select("st.tSmsText AS st_sms_text");
            $this->db->select("st.eStatus AS st_status");
        }
        else
        {
            $this->db->select("st.iSmsTemplateId AS iSmsTemplateId");
            $this->db->select("st.iSmsTemplateId AS st_sms_template_id");
            $this->db->select("st.vTemplateCode AS st_template_code");
            $this->db->select("st.tSmsText AS st_sms_text");
            $this->db->select("st.eStatus AS st_status");
            $this->db->select("st.dtAddedAt AS st_added_at");
            $this->db->select("st.dtUpdatedAt AS st_updated_at");
        }
    ...
    {
        $list_config = array(
            "st_template_code" => array(
                "name" => "st_template_code",
                "table_name" => "sms_template",
                "table_alias" => "st",
                "field_name" => "vTemplateCode",
                "source_field" => "st_template_code",
                "display_query" => "st.vTemplateCode",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Template Code",
                "lang_code" => "SMS_TEMPLATE_TEMPLATE_CODE",
                "label_lang" => $this->lang->line('SMS_TEMPLATE_TEMPLATE_CODE'),
                "width" => 50,
                "search" => "Yes",
                "export" => "No",
                "sortable" => "Yes",
            ...
            "st_sms_text" => array(
                ...
                "table_alias" => "st",
                "field_name" => "tSmsText",
                "source_field" => "st_sms_text",
                "display_query" => "st.tSmsText",
                "entry_type" => "Table",
                "data_type" => "text",
                "show_in" => "Both",
                "type" => "textarea",
                "align" => "left",
                "label" => "Sms Text",
                "lang_code" => "SMS_TEMPLATE_SMS_TEXT",
                "label_lang" => $this->lang->line('SMS_TEMPLATE_SMS_TEXT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "No",
                "sortable" => "Yes",
            ...
            "st_status" => array(
                ...
                "table_alias" => "st",
                "field_name" => "eStatus",
                "source_field" => "st_status",
                "display_query" => "st.eStatus",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Status",
                "lang_code" => "SMS_TEMPLATE_STATUS",
                "label_lang" => $this->lang->line('SMS_TEMPLATE_STATUS'),
                "width" => 50,
                "search" => "Yes",
                "export" => "No",
                "sortable" => "Yes",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "st_added_at" => array(
                ...
                "type" => "date",
                "label" => "Added At",
                "lang_code" => "SMS_TEMPLATE_ADDED_AT",
                "label_lang" => $this->lang->line('SMS_TEMPLATE_ADDED_AT'),
                "default" => $this->filter->getDefaultValue("st_added_at",
                "MySQL",
                "NOW()"),
                "dfapply" => "forceApply",
            ...
            "st_updated_at" => array(
                ...
                "type" => "date",
                "label" => "Updated At",
                "lang_code" => "SMS_TEMPLATE_UPDATED_AT",
                "label_lang" => $this->lang->line('SMS_TEMPLATE_UPDATED_AT'),
                "default" => $this->filter->getDefaultValue("st_updated_at",
                "MySQL",
                "NOW()"),
                "dfapply" => "forceApply",
                "format" => $this->general->getAdminPHPFormats('date')
