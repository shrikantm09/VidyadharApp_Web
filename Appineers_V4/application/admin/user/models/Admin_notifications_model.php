...
/**
 * Description of Admin Notifications Model
 *
 * @category admin
 *
 * @package user
 ...
 *
 * @class Admin_notifications_model.php
 *
 * @path application\admin\user\models\Admin_notifications_model.php
 *
 * @version 4.3
 *
 * @author CIT Dev Team
...
class Admin_notifications_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->table_name = "mod_admin_notifications";
        $this->table_alias = "man";
        $this->primary_key = "iNotificationId";
        $this->primary_alias = "man_notification_id";
        ...
        $this->join_tables = array(
            array(
                ...
                "table_alias" => "ma",
                "field_name" => "iAdminId",
                "rel_table_name" => "mod_admin_notifications",
                "rel_table_alias" => "man",
                "rel_field_name" => "iSentBy",
                "join_type" => "left",
                "extra_condition" => "",
            )
        );
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("man.tMessage AS man_message");
            $this->db->select("ma.vName AS ma_name");
            $this->db->select("man.dAddedDate AS man_added_date");
            $this->db->select("('View') AS view", FALSE);
            $this->db->select("(man.dAddedDate) AS sent_period", FALSE);
        }
        else
        {
            $this->db->select("man.iNotificationId AS iNotificationId");
            $this->db->select("man.iNotificationId AS man_notification_id");
            $this->db->select("man.tMessage AS man_message");
            $this->db->select("man.iSentBy AS man_sent_by");
            $this->db->select("man.dAddedDate AS man_added_date");
            $this->db->select("man.iAdminId AS man_admin_id");
            $this->db->select("man.iGroupId AS man_group_id");
            $this->db->select("man.eIsRead AS man_is_read");
            $this->db->select("man.eStatus AS man_status");
        }
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            "man_message" => array(
                "name" => "man_message",
                "table_name" => "mod_admin_notifications",
                "table_alias" => "man",
                "field_name" => "tMessage",
                "source_field" => "man_message",
                "display_query" => "man.tMessage",
                "entry_type" => "Table",
                "data_type" => "text",
                "show_in" => "Both",
                "type" => "textarea",
                "align" => "left",
                "label" => "Message",
                "label_lang" => $this->lang->line('ADMIN_NOTIFICATIONS_MESSAGE'),
                "width" => 150,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "ma_name" => array(
                ...
                "align" => "center",
                "label" => "Sent By",
                "label_lang" => $this->lang->line('ADMIN_NOTIFICATIONS_SENT_BY'),
                "width" => 75,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "man_added_date" => array(
                "name" => "man_added_date",
                "table_name" => "mod_admin_notifications",
                "table_alias" => "man",
                "field_name" => "dAddedDate",
                "source_field" => "man_added_date",
                "display_query" => "man.dAddedDate",
                "entry_type" => "Table",
                "data_type" => "timestamp",
                "show_in" => "Both",
                "type" => "date_and_time",
                "align" => "center",
                "label" => "Sent DateTime",
                "label_lang" => $this->lang->line('ADMIN_NOTIFICATIONS_SENT_DATETIME'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("man_added_date",
                "MySQL",
                "NOW()"),
            ...
            "view" => array(
                ...
                "align" => "center",
                "label" => "View",
                "label_lang" => $this->lang->line('ADMIN_NOTIFICATIONS_VIEW'),
                "width" => 50,
                "search" => "No",
                "export" => "No",
                "sortable" => "Yes",
            ...
            "sent_period" => array(
                ...
                "align" => "left",
                "label" => "Sent Period",
                "label_lang" => $this->lang->line('ADMIN_NOTIFICATIONS_SENT_PERIOD'),
                "width" => 100,
                "search" => "No",
                "export" => "No",
                "sortable" => "No",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "man_added_date" => array(
                ...
                "type" => "date_and_time",
                "label" => "Sent Date",
                "label_lang" => $this->lang->line('ADMIN_NOTIFICATIONS_SENT_DATE'),
                "default" => $this->filter->getDefaultValue("man_added_date",
                "MySQL",
                "NOW()"),
                "dfapply" => "addOnly",
            ...
            "man_admin_id" => array(
                ...
                "type" => "dropdown",
                "label" => "Admin Id",
                "label_lang" => $this->lang->line('ADMIN_NOTIFICATIONS_ADMIN_ID')
            ),
            "man_group_id" => array(
                "name" => "man_group_id",
                "table_name" => "mod_admin_notifications",
                ...
                "type" => "dropdown",
                "label" => "Group Id",
                "label_lang" => $this->lang->line('ADMIN_NOTIFICATIONS_GROUP_ID')
            ),
            "man_is_read" => array(
                "name" => "man_is_read",
                "table_name" => "mod_admin_notifications",
                ...
                "type" => "dropdown",
                "label" => "Is Read",
                "label_lang" => $this->lang->line('ADMIN_NOTIFICATIONS_IS_READ'),
                "default" => $this->filter->getDefaultValue("man_is_read",
                "Text",
                "No"),
                "dfapply" => "forceApply",
            ),
            "man_status" => array(
                ...
                "type" => "dropdown",
                "label" => "Status",
                "label_lang" => $this->lang->line('ADMIN_NOTIFICATIONS_STATUS'),
                "default" => $this->filter->getDefaultValue("man_status",
                "Text",
                "Active"),
                "dfapply" => "forceApply",
            )
        ...
        $custom_link_config = array(
            "view" => array(
                array(
                    ...
                    "module_type" => "Module",
                    "module_name" => "admin_notifications",
                    "folder_name" => "user",
                    "module_page" => "View",
                    "custom_link" => "",
                    "extra_params" => array(
