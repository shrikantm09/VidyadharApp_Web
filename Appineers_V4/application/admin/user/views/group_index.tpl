...
<%javascript%>
    ...
    },
    {
        ...
        "export": <%if $list_config['mgm_group_code']['export'] eq 'No' %>false<%else%>true<%/if%>,
        ...
        "hideme": <%if $list_config['mgm_group_code']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
    ...
    },
    {
        ...
        "export": <%if $list_config['mgm_status']['export'] eq 'No' %>false<%else%>true<%/if%>,
        ...
        "hideme": <%if $list_config['mgm_status']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
