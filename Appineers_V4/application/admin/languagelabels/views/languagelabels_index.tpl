...
<div class="module-list-container">
    <%include file="languagelabels_index_strip.tpl"%>
...
<%javascript%>
    ...
    js_col_name_json = [{
        "name": "mll_label",
        "label": "<%$list_config['mll_label']['label_lang']%>"
    },
    {
        "name": "mlll_title",
        "label": "<%$list_config['mlll_title']['label_lang']%>"
    },
    {
        "name": "mll_module",
        "label": "<%$list_config['mll_module']['label_lang']%>"
    },
    {
        "name": "mll_status",
        "label": "<%$list_config['mll_status']['label_lang']%>"
    }];
    ...
    js_col_model_json = [{
        ...
        "resizable": true,
        "width": "<%$list_config['mll_label']['width']%>",
        "search": <%if $list_config['mll_label']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['mll_label']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['mll_label']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['mll_label']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['mll_label']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['mll_label']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['mll_label']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "required": true,
        ...
        "searchoptions": {
            ...
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['mll_label']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "languagelabels",
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['mll_label']['default']%>",
        "filterSopt": "bw",
    ...
    },
    {
        ...
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['mlll_title']['width']%>",
        "search": <%if $list_config['mlll_title']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['mlll_title']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['mlll_title']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['mlll_title']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['mlll_title']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['mlll_title']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['mlll_title']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "select",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            ...
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['mlll_title']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "languagelabels",
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['mlll_title']['default']%>",
        "filterSopt": "bw"
    },
    {
        "name": "mll_module",
        ...
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['mll_module']['width']%>",
        "search": <%if $list_config['mll_module']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['mll_module']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['mll_module']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['mll_module']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['mll_module']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['mll_module']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['mll_module']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "select",
        "editrules": {
            "required": true,
        ...
        "searchoptions": {
            ...
            "sopt": intSearchOpts,
            "searchhidden": <%if $list_config['mll_module']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
            "dataUrl": <%if $count_arr["mll_module"]["json"] eq "Yes" %>false<%else%>'<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mll_module&mode=<%$mod_enc_mode["Search"]%>&rformat=html<%$extra_qstr%>'<%/if%>,
            "value": <%if $count_arr["mll_module"]["json"] eq "Yes" %>$.parseJSON('<%$count_arr["mll_module"]["data"]|@addslashes%>')<%else%>null<%/if%>,
            "dataInit": <%if $count_arr['mll_module']['ajax'] eq 'Yes' %>initSearchGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mll_module"]["ajax"] eq "Yes" %>ajax-call<%/if%>',
            "multiple": true
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "languagelabels",
            "aria-unique-name": "mll_module",
            "dataUrl": '<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mll_module&mode=<%$mod_enc_mode["Update"]%>&rformat=html<%$extra_qstr%>',
            "dataInit": <%if $count_arr['mll_module']['ajax'] eq 'Yes' %>initEditGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mll_module"] eq "Yes" %>ajax-call<%/if%>',
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'LANGUAGELABELS_MODULE')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
        "default_value": "<%$list_config['mll_module']['default']%>",
        "filterSopt": "in",
        "stype": "select"
    },
    {
        ...
        "resizable": true,
        "width": "<%$list_config['mll_status']['width']%>",
        "search": <%if $list_config['mll_status']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['mll_status']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['mll_status']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['mll_status']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['mll_status']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['mll_status']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['mll_status']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "center",
        "edittype": "select",
        "editrules": {
            "required": true,
        ...
        "searchoptions": {
            ...
            "sopt": intSearchOpts,
            "searchhidden": <%if $list_config['mll_status']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
            "dataUrl": <%if $count_arr["mll_status"]["json"] eq "Yes" %>false<%else%>'<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mll_status&mode=<%$mod_enc_mode["Search"]%>&rformat=html<%$extra_qstr%>'<%/if%>,
            "value": <%if $count_arr["mll_status"]["json"] eq "Yes" %>$.parseJSON('<%$count_arr["mll_status"]["data"]|@addslashes%>')<%else%>null<%/if%>,
            "dataInit": <%if $count_arr['mll_status']['ajax'] eq 'Yes' %>initSearchGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mll_status"]["ajax"] eq "Yes" %>ajax-call<%/if%>',
            "multiple": true
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "languagelabels",
            "aria-unique-name": "mll_status",
            "dataUrl": '<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mll_status&mode=<%$mod_enc_mode["Update"]%>&rformat=html<%$extra_qstr%>',
            "dataInit": <%if $count_arr['mll_status']['ajax'] eq 'Yes' %>initEditGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mll_status"] eq "Yes" %>ajax-call<%/if%>',
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'LANGUAGELABELS_STATUS')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
        "default_value": "<%$list_config['mll_status']['default']%>",
        "filterSopt": "in",
        "stype": "select"
    }];
