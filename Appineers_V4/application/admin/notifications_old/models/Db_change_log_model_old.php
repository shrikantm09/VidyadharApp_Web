...
/**
 * Description of DB Change Log Model
 *
 * @category admin
 *
 ...
 *
 * @class Db_change_log_model.php
 *
 * @path application\admin\notifications\models\Db_change_log_model.php
 *
 * @version 4.3
 *
 * @author CIT Dev Team
...
class Db_change_log_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_name = "mod_db_changelog";
        $this->table_alias = "mdc";
        $this->primary_key = "iDBChangelogId";
        $this->primary_alias = "mdc_db_changelog_id";
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("mdc.vLoggedName AS mdc_logged_name");
            $this->db->select("mdc.dDateAdded AS mdc_date_added");
            $this->db->select("('Extra Fields') AS extra_fields", FALSE);
        }
        else
        {
            $this->db->select("mdc.iDBChangelogId AS iDBChangelogId");
    ...
    {
        $list_config = array(
            "mdc_table_name" => array(
                "name" => "mdc_table_name",
                "table_name" => "mod_db_changelog",
                "table_alias" => "mdc",
                "field_name" => "vTableName",
                "source_field" => "mdc_table_name",
                "display_query" => "mdc.vTableName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "center",
                "label" => "Table Name",
                "lang_code" => "DB_CHANGE_LOG_TABLE_NAME",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_TABLE_NAME'),
                "width" => 150,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "mdc_operation" => array(
                ...
                "table_name" => "mod_db_changelog",
                "table_alias" => "mdc",
                "field_name" => "eOperation",
                "source_field" => "mdc_operation",
                "display_query" => "mdc.eOperation",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Operation",
                "lang_code" => "DB_CHANGE_LOG_OPERATION",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_OPERATION'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("mdc_operation",
                "Text",
                "Modified")
            ),
            "mdc_primary_key" => array(
                "name" => "mdc_primary_key",
                "table_name" => "mod_db_changelog",
                "table_alias" => "mdc",
                "field_name" => "iPrimaryKey",
                "source_field" => "mdc_primary_key",
                "display_query" => "mdc.iPrimaryKey",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "center",
                "label" => "Primary Key",
                "lang_code" => "DB_CHANGE_LOG_PRIMARY_KEY",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_PRIMARY_KEY'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "No",
            ...
            "mdc_field_data" => array(
                "name" => "mdc_field_data",
                "table_name" => "mod_db_changelog",
                "table_alias" => "mdc",
                "field_name" => "tFieldData",
                "source_field" => "mdc_field_data",
                "display_query" => "mdc.tFieldData",
                "entry_type" => "Table",
                "data_type" => "text",
                "show_in" => "Both",
                "type" => "textarea",
                "align" => "center",
                "label" => "Field Data",
                "lang_code" => "DB_CHANGE_LOG_FIELD_DATA",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_FIELD_DATA'),
                "width" => 50,
                "search" => "No",
                "export" => "Yes",
                "sortable" => "No",
            ...
            "mdc_source" => array(
                ...
                "table_alias" => "mdc",
                "field_name" => "eSource",
                "source_field" => "mdc_source",
                "display_query" => "mdc.eSource",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Source",
                "lang_code" => "DB_CHANGE_LOG_SOURCE",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_SOURCE'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("mdc_source",
                "Text",
                "Other")
            ),
            "mdc_entity_name" => array(
                "name" => "mdc_entity_name",
                "table_name" => "mod_db_changelog",
                "table_alias" => "mdc",
                "field_name" => "vEntityName",
                "source_field" => "",
                "display_query" => "mdc.vEntityName",
                "entry_type" => "Table",
                "data_type" => "",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "center",
                "label" => "Entity",
                "lang_code" => "DB_CHANGE_LOG_ENTITY",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_ENTITY'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "mdc_logged_name" => array(
                "name" => "mdc_logged_name",
                "table_name" => "mod_db_changelog",
                "table_alias" => "mdc",
                "field_name" => "vLoggedName",
                "source_field" => "mdc_logged_name",
                "display_query" => "mdc.vLoggedName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "center",
                "label" => "Done By",
                "lang_code" => "DB_CHANGE_LOG_DONE_BY",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_DONE_BY'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "mdc_date_added" => array(
                "name" => "mdc_date_added",
                "table_name" => "mod_db_changelog",
                "table_alias" => "mdc",
                "field_name" => "dDateAdded",
                "source_field" => "mdc_date_added",
                "display_query" => "mdc.dDateAdded",
                "entry_type" => "Table",
                "data_type" => "datetime",
                "show_in" => "Both",
                "type" => "date_and_time",
                "align" => "center",
                "label" => "Done At",
                "lang_code" => "DB_CHANGE_LOG_DONE_AT",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_DONE_AT'),
                "width" => 150,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("mdc_date_added",
                "MySQL",
                "NOW()"),
            ...
            "extra_fields" => array(
                ...
                "align" => "center",
                "label" => "Extra Fields",
                "lang_code" => "DB_CHANGE_LOG_EXTRA_FIELDS",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_EXTRA_FIELDS'),
                "width" => 50,
                "search" => "No",
                "export" => "No",
                "sortable" => "No",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "mdc_logged_by_id" => array(
                "name" => "mdc_logged_by_id",
                "table_name" => "mod_db_changelog",
                "table_alias" => "mdc",
                "field_name" => "iLoggedById",
                "entry_type" => "Table",
                "data_type" => "int",
                "type" => "textbox",
                "label" => "Logged By Id",
                "lang_code" => "DB_CHANGE_LOG_LOGGED_BY_ID",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_LOGGED_BY_ID')
            ),
            "mdc_logged_name" => array(
                "name" => "mdc_logged_name",
                "table_name" => "mod_db_changelog",
                ...
                "type" => "textbox",
                "label" => "Logged Name",
                "lang_code" => "DB_CHANGE_LOG_LOGGED_NAME",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_LOGGED_NAME')
            ),
            "mdc_date_added" => array(
                "name" => "mdc_date_added",
                "table_name" => "mod_db_changelog",
                ...
                "type" => "date_and_time",
                "label" => "Date Added",
                "lang_code" => "DB_CHANGE_LOG_DATE_ADDED",
                "label_lang" => $this->lang->line('DB_CHANGE_LOG_DATE_ADDED'),
                "default" => $this->filter->getDefaultValue("mdc_date_added",
                "MySQL",
                "NOW()"),
                "dfapply" => "addOnly",
