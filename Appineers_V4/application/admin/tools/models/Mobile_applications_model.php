...
/**
 * Description of Mobile Applications Model
 *
 * @category admin
 *
 * @package tools
 ...
 *
 * @class Mobile_applications_model.php
 *
 * @path application\admin\tools\models\Mobile_applications_model.php
 *
 * @version 4.3
 *
 * @author CIT Dev Team
...
class Mobile_applications_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_name = "mod_application_master";
        $this->table_alias = "mam";
        $this->primary_key = "iApplicationMasterId";
        $this->primary_alias = "mam_application_master_id";
        ...
        $this->switchto_fields = array(
            $this->db->protect("mam.vApplicationName")
        );
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("mam.vApplicationName AS mam_application_name");
            $this->db->select("mam.eDeviceType AS mam_device_type");
            $this->db->select("ma.vName AS ma_name");
            $this->db->select("mam.eStatus AS mam_status");
        }
        else
        {
            $this->db->select("mam.iApplicationMasterId AS iApplicationMasterId");
            $this->db->select("mam.iApplicationMasterId AS mam_application_master_id");
            $this->db->select("mam.vApplicationName AS mam_application_name");
            $this->db->select("mam.eDeviceType AS mam_device_type");
            $this->db->select("mam.eStatus AS mam_status");
            $this->db->select("mam.dDateAdded AS mam_date_added");
            $this->db->select("mam.iAddedBy AS mam_added_by");
            $this->db->select("mam.dDateUpdated AS mam_date_updated");
            $this->db->select("mam.iUpdatedBy AS mam_updated_by");
        }
    ...
    {
        $list_config = array(
            "mam_application_name" => array(
                "name" => "mam_application_name",
                "table_name" => "mod_application_master",
                "table_alias" => "mam",
                "field_name" => "vApplicationName",
                "source_field" => "mam_application_name",
                "display_query" => "mam.vApplicationName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                ...
                "label_lang" => $this->lang->line('MOBILE_APPLICATIONS_APPLICATION_NAME'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "mam_device_type" => array(
                ...
                "source_field" => "mam_device_type",
                "display_query" => "mam.eDeviceType",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Device Type",
                "label_lang" => $this->lang->line('MOBILE_APPLICATIONS_DEVICE_TYPE'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("mam_device_type",
                "Text",
                "IOS")
            ),
            "ma_name" => array(
                ...
                "align" => "left",
                "label" => "Added By",
                "label_lang" => $this->lang->line('MOBILE_APPLICATIONS_ADDED_BY'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "viewedit" => "No",
                "related" => "Yes",
                "default" => $this->filter->getDefaultValue("mam_added_by",
                "Session",
                "iAdminId")
            ),
            "mam_status" => array(
                ...
                "table_alias" => "mam",
                "field_name" => "eStatus",
                "source_field" => "mam_status",
                "display_query" => "mam.eStatus",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Status",
                "label_lang" => $this->lang->line('MOBILE_APPLICATIONS_STATUS'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("mam_status",
                "Text",
                "Active")
            )
        );
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "mam_date_added" => array(
                ...
                "type" => "date",
                "label" => "Date Added",
                "label_lang" => $this->lang->line('MOBILE_APPLICATIONS_DATE_ADDED'),
                "default" => $this->filter->getDefaultValue("mam_date_added",
                "MySQL",
                "NOW()"),
                "dfapply" => "addOnly",
            ...
            "mam_date_updated" => array(
                "name" => "mam_date_updated",
                "table_name" => "mod_application_master",
                "table_alias" => "mam",
                ...
                "type" => "date",
                "label" => "Date Updated",
                "label_lang" => $this->lang->line('MOBILE_APPLICATIONS_DATE_UPDATED'),
                "default" => $this->filter->getDefaultValue("mam_date_updated",
                "MySQL",
                "NOW()"),
                "dfapply" => "forceApply",
                "format" => $this->general->getAdminPHPFormats('date')
            ...
            "mam_updated_by" => array(
                ...
                "type" => "dropdown",
                "label" => "Updated By",
                "label_lang" => $this->lang->line('MOBILE_APPLICATIONS_UPDATED_BY'),
                "default" => $this->filter->getDefaultValue("mam_updated_by",
                "Session",
                "iAdminId"),
                "dfapply" => "forceApply",
            )
    ...
    public function getVersionsDetails()
    {
        ...
        $this->db->select("mav.vApplicationUrl AS application_url");
        ...
        $this->db->order_by("mav.dDatePublished", "DESC");
        $db_rec_obj = $this->db->get();
        $db_rec_arr = is_object($db_rec_obj) ? $db_rec_obj->result_array() : "empty";
