...
/**
 * Description of System Emails Model
 *
 * @category admin
 *
 * @package tools
 ...
 *
 * @class Systememails_model.php
 *
 * @path application\admin\tools\models\Systememails_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Systememails_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_alias = "mse";
        $this->primary_key = "iEmailTemplateId";
        $this->primary_alias = "mse_email_template_id";
        ...
        $this->switchto_fields = array(
            $this->db->protect("mse.vEmailTitle")
        );
        $this->switchto_options = array(
            $this->db->protect("mse.vEmailTitle")." AS email_title",
        );
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("mse.vEmailTitle AS mse_email_title");
            $this->db->select("mse.vEmailCode AS mse_email_code");
            $this->db->select("mse.vFromName AS mse_from_name");
            $this->db->select("mse.eStatus AS mse_status");
        }
        else
        {
            $this->db->select("mse.iEmailTemplateId AS iEmailTemplateId");
            $this->db->select("mse.iEmailTemplateId AS mse_email_template_id");
            $this->db->select("mse.vEmailCode AS mse_email_code");
            $this->db->select("mse.vEmailTitle AS mse_email_title");
            $this->db->select("mse.vFromName AS mse_from_name");
            $this->db->select("mse.vFromEmail AS mse_from_email");
            $this->db->select("mse.vBccEmail AS mse_bcc_email");
            $this->db->select("mse.vCcEmail AS mse_cc_email");
            $this->db->select("mse.vEmailSubject AS mse_email_subject");
            $this->db->select("mse.tEmailMessage AS mse_email_message");
            $this->db->select("mse.eStatus AS mse_status");
        }
    ...
    {
        $list_config = array(
            "mse_email_title" => array(
                "name" => "mse_email_title",
                "table_name" => "mod_system_email",
                "table_alias" => "mse",
                "field_name" => "vEmailTitle",
                "source_field" => "mse_email_title",
                "display_query" => "mse.vEmailTitle",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Email Title",
                "lang_code" => "SYSTEMEMAILS_EMAIL_TITLE",
                "label_lang" => $this->lang->line('SYSTEMEMAILS_EMAIL_TITLE'),
                "width" => 250,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "mse_email_code" => array(
                "name" => "mse_email_code",
                "table_name" => "mod_system_email",
                "table_alias" => "mse",
                "field_name" => "vEmailCode",
                "source_field" => "mse_email_code",
                "display_query" => "mse.vEmailCode",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Email Code",
                "lang_code" => "SYSTEMEMAILS_EMAIL_CODE",
                "label_lang" => $this->lang->line('SYSTEMEMAILS_EMAIL_CODE'),
                "width" => 200,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "mse_from_name" => array(
                ...
                "table_name" => "mod_system_email",
                "table_alias" => "mse",
                "field_name" => "vFromName",
                "source_field" => "mse_from_name",
                "display_query" => "mse.vFromName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "From Name",
                "lang_code" => "SYSTEMEMAILS_FROM_NAME",
                "label_lang" => $this->lang->line('SYSTEMEMAILS_FROM_NAME'),
                "width" => 150,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "mse_status" => array(
                ...
                "table_alias" => "mse",
                "field_name" => "eStatus",
                "source_field" => "mse_status",
                "display_query" => "mse.eStatus",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Status",
                "lang_code" => "SYSTEMEMAILS_STATUS",
                "label_lang" => $this->lang->line('SYSTEMEMAILS_STATUS'),
                "width" => 150,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "mse_from_email" => array(
                "name" => "mse_from_email",
                "table_name" => "mod_system_email",
                "table_alias" => "mse",
                "field_name" => "vFromEmail",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "From Email",
                "lang_code" => "SYSTEMEMAILS_FROM_EMAIL",
                "label_lang" => $this->lang->line('SYSTEMEMAILS_FROM_EMAIL')
            ),
            "mse_bcc_email" => array(
                "name" => "mse_bcc_email",
                "table_name" => "mod_system_email",
                "table_alias" => "mse",
                "field_name" => "vBccEmail",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "Bcc Email",
                "lang_code" => "SYSTEMEMAILS_BCC_EMAIL",
                "label_lang" => $this->lang->line('SYSTEMEMAILS_BCC_EMAIL')
            ),
            "mse_cc_email" => array(
                "name" => "mse_cc_email",
                "table_name" => "mod_system_email",
                ...
                "type" => "textbox",
                "label" => "Cc Email",
                "lang_code" => "SYSTEMEMAILS_CC_EMAIL",
                "label_lang" => $this->lang->line('SYSTEMEMAILS_CC_EMAIL')
            ),
            "mse_email_subject" => array(
                "name" => "mse_email_subject",
                "table_name" => "mod_system_email",
                "table_alias" => "mse",
                "field_name" => "vEmailSubject",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "Email Subject",
                "lang_code" => "SYSTEMEMAILS_EMAIL_SUBJECT",
                "label_lang" => $this->lang->line('SYSTEMEMAILS_EMAIL_SUBJECT')
            ),
            "mse_email_message" => array(
                "name" => "mse_email_message",
                "table_name" => "mod_system_email",
                "table_alias" => "mse",
                "field_name" => "tEmailMessage",
                "entry_type" => "Table",
                "data_type" => "text",
                "show_input" => "Both",
                "type" => "wysiwyg",
                "label" => "Email Message",
                "lang_code" => "SYSTEMEMAILS_EMAIL_MESSAGE",
                "label_lang" => $this->lang->line('SYSTEMEMAILS_EMAIL_MESSAGE')
            ),
            "mse_status" => array(
                "name" => "mse_status",
                "table_name" => "mod_system_email",
    ...
    /**
     * insertVariables method is used to insert system email variable entries.
     * @param array $data data array for insert into group rights table.
     * @return numeric $insert_id returns last inserted id.
     */
    public function insertVariables($data = array())
    {
        $this->db->insert('mod_system_email_vars', $data);
        $insert_id = $this->db->insert_id();
        return $insert_id;
    }

    /**
     * deleteVariables method is used to delete data records from system email variable table.
     * @param string $where where is the query condition for deleting.
     * @return boolean $res returns TRUE or FALSE.
     */
    public function deleteVariables($where = "")
    {
        if (is_numeric($where))
        {
            $this->db->where('iEmailTemplateId', $where);
        }
        else
        {
            $this->db->where($where, FALSE, FALSE);
        }
        $res = $this->db->delete('mod_system_email_vars');
        return $res;
    }

    /**
     * getVariableData method is used to get data records of system email variable table.
     * @param string $where where is the query condition for filtered data.
     * @return array $db_var_arr returns data array records.
     */
    public function getVariableData($where = '')
    {
        $this->db->select('*');
        if (is_numeric($where))
        {
        ...
        $db_var_arr_obj = $this->db->get('mod_system_email_vars');
        $db_var_arr = is_object($db_var_arr_obj) ? $db_var_arr_obj->result_array() : array();
        return $db_var_arr;
    }
}
