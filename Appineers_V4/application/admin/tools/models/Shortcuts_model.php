...
/**
 * Description of Shortcuts Model
 *
 * @category admin
 *
 * @package tools
 ...
 * @module Shortcuts
 *
 * @class Shortcuts_model.php
 *
 * @path application\admin\tools\models\Shortcuts_model.php
 *
 * @version 4.3
 *
 * @author CIT Dev Team
...
class Shortcuts_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_name = "mod_shortcuts";
        $this->table_alias = "ms";
        $this->primary_key = "iShortcutId";
        $this->primary_alias = "ms_mod_shortcuts_id";
        ...
        $this->switchto_fields = array(
            $this->db->protect("ms.vShortcutName")
        );
        $this->switchto_options = array(
            $this->db->protect("ms.vShortcutName")." AS shortcut_name",
        );
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("ms.vShortcutKey AS ms_shortcut_key");
            $this->db->select("ms.vShortcutName AS ms_shortcut_name");
            $this->db->select("ms.eShortcutType AS ms_shortcut_type");
            $this->db->select("ms.eShortcutMode AS ms_shortcut_mode");
            $this->db->select("ms.dAddedDate AS ms_added_date");
            $this->db->select("ms.dModifiedDate AS ms_modified_date");
            $this->db->select("ms.eStatus AS ms_status");
        }
        else
        {
            $this->db->select("ms.iShortcutId AS iShortcutId");
            $this->db->select("ms.iShortcutId AS ms_mod_shortcuts_id");
            $this->db->select("ms.vShortcutKey AS ms_shortcut_key");
            $this->db->select("ms.vShortcutName AS ms_shortcut_name");
            $this->db->select("ms.eShortcutType AS ms_shortcut_type");
            $this->db->select("ms.eStatus AS ms_status");
            $this->db->select("ms.eShortcutMode AS ms_shortcut_mode");
            $this->db->select("ms.tNavigateJSON AS ms_navigate_json");
            $this->db->select("ms.dAddedDate AS ms_added_date");
            $this->db->select("ms.dModifiedDate AS ms_modified_date");
        }
    ...
    {
        $list_config = array(
            "ms_shortcut_key" => array(
                "name" => "ms_shortcut_key",
                "table_name" => "mod_shortcuts",
                "table_alias" => "ms",
                "field_name" => "vShortcutKey",
                "source_field" => "ms_shortcut_key",
                "display_query" => "ms.vShortcutKey",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Shortcut Key",
                "label_lang" => $this->lang->line('SHORTCUTS_SHORTCUT_KEY'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "ms_shortcut_name" => array(
                "name" => "ms_shortcut_name",
                "table_name" => "mod_shortcuts",
                "table_alias" => "ms",
                "field_name" => "vShortcutName",
                "source_field" => "ms_shortcut_name",
                "display_query" => "ms.vShortcutName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Shortcut Name",
                "label_lang" => $this->lang->line('SHORTCUTS_SHORTCUT_NAME'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "ms_shortcut_type" => array(
                ...
                "table_name" => "mod_shortcuts",
                "table_alias" => "ms",
                "field_name" => "eShortcutType",
                "source_field" => "ms_shortcut_type",
                "display_query" => "ms.eShortcutType",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "radio_buttons",
                "align" => "center",
                "label" => "Shortcut Type",
                "label_lang" => $this->lang->line('SHORTCUTS_SHORTCUT_TYPE'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("ms_shortcut_type",
                "Text",
                "Menu")
            ),
            "ms_shortcut_mode" => array(
                ...
                "table_name" => "mod_shortcuts",
                "table_alias" => "ms",
                "field_name" => "eShortcutMode",
                "source_field" => "ms_shortcut_mode",
                "display_query" => "ms.eShortcutMode",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Shortcut Mode",
                "label_lang" => $this->lang->line('SHORTCUTS_SHORTCUT_MODE'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("ms_shortcut_mode",
                "Text",
                "Custom")
            ),
            "ms_added_date" => array(
                ...
                "source_field" => "ms_added_date",
                "display_query" => "ms.dAddedDate",
                "entry_type" => "Table",
                "data_type" => "datetime",
                "show_in" => "Both",
                "type" => "date_and_time",
                "align" => "left",
                "label" => "Added Date",
                "label_lang" => $this->lang->line('SHORTCUTS_ADDED_DATE'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("ms_added_date",
                "MySQL",
                "NOW()"),
                "format" => $this->general->getAdminPHPFormats('date_and_time')
            ),
            "ms_modified_date" => array(
                "name" => "ms_modified_date",
                "table_name" => "mod_shortcuts",
                "table_alias" => "ms",
                "field_name" => "dModifiedDate",
                "source_field" => "ms_modified_date",
                "display_query" => "ms.dModifiedDate",
                "entry_type" => "Table",
                "data_type" => "datetime",
                "show_in" => "Both",
                "type" => "date_and_time",
                "align" => "left",
                "label" => "Modified Date",
                "label_lang" => $this->lang->line('SHORTCUTS_MODIFIED_DATE'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("ms_modified_date",
                "MySQL",
                "NOW()"),
                "format" => $this->general->getAdminPHPFormats('date_and_time')
            ),
            "ms_status" => array(
                ...
                "table_alias" => "ms",
                "field_name" => "eStatus",
                "source_field" => "ms_status",
                "display_query" => "ms.eStatus",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Status",
                "label_lang" => $this->lang->line('SHORTCUTS_STATUS'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("ms_status",
                "Text",
                "Active")
            )
        );
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "sys_custom_menu" => array(
                ...
                "type" => "dropdown",
                "label" => "Menu",
                "label_lang" => $this->lang->line('SHORTCUTS_MENU')
            ),
            "sys_custom_module" => array(
                "name" => "sys_custom_module",
                "table_name" => "",
                "table_alias" => "",
                ...
                "type" => "dropdown",
                "label" => "Module",
                "label_lang" => $this->lang->line('SHORTCUTS_MODULE')
            ),
            "sys_custom_code" => array(
                "name" => "sys_custom_code",
                "table_name" => "",
                "table_alias" => "",
                ...
                "type" => "textbox",
                "label" => "Custom Code",
                "label_lang" => $this->lang->line('SHORTCUTS_CUSTOM_CODE')
            ),
            "sys_custom_general" => array(
                "name" => "sys_custom_general",
                "table_name" => "",
                "table_alias" => "",
                ...
                "type" => "dropdown",
                "label" => "General",
                "label_lang" => $this->lang->line('SHORTCUTS_GENERAL')
            ),
            "ms_status" => array(
                "name" => "ms_status",
                "table_name" => "mod_shortcuts",
            ...
            "ms_navigate_json" => array(
                "name" => "ms_navigate_json",
                "table_name" => "mod_shortcuts",
                "table_alias" => "ms",
                "field_name" => "tNavigateJSON",
                "entry_type" => "Table",
                "data_type" => "text",
                "type" => "textarea",
                "label" => "Navigate Json",
                "label_lang" => $this->lang->line('SHORTCUTS_NAVIGATE_JSON')
            ),
            "ms_added_date" => array(
                "name" => "ms_added_date",
                "table_name" => "mod_shortcuts",
