 ...
 * @module Static Pages
 *
 * @class Staticpages_model.php
 *
 * @path application\admin\tools\models\Staticpages_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Staticpages_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->table_name = "mod_page_settings";
        $this->table_alias = "mps";
        $this->primary_key = "iPageId";
        $this->primary_alias = "mps_page_id";
        ...
        $this->switchto_fields = array(
            $this->db->protect("mps.vPageTitle")
        );
        $this->switchto_options = array(
            $this->db->protect("mps.vPageTitle")." AS page_title",
        );
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        {
            $this->db->select("mps.iPageId AS iPageId");
            $this->db->select("mps.iPageId AS mps_page_id");
            $this->db->select("mps.vPageTitle AS mps_page_title");
            $this->db->select("mps.vPageCode AS mps_page_code");
            $this->db->select("mps.vUrl AS mps_url");
            $this->db->select("mps.vVersion AS mps_version");
            $this->db->select("mps.vContent AS mps_content");
            $this->db->select("mps.tMetaTitle AS mps_meta_title");
            $this->db->select("mps.tMetaKeyword AS mps_meta_keyword");
            $this->db->select("mps.tMetaDesc AS mps_meta_desc");
            $this->db->select("mps.dtDatecreated AS mps_t_datecreated");
            $this->db->select("mps.eStatus AS mps_status");
        }
    ...
    {
        $list_config = array(
            "mps_page_title" => array(
                "name" => "mps_page_title",
                "table_name" => "mod_page_settings",
                "table_alias" => "mps",
                "field_name" => "vPageTitle",
                "source_field" => "mps_page_title",
                "display_query" => "mps.vPageTitle",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Page Title",
                "lang_code" => "STATICPAGES_PAGE_TITLE",
                "label_lang" => $this->lang->line('STATICPAGES_PAGE_TITLE'),
                "width" => 900,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "mps_page_code" => array(
                ...
                "table_name" => "mod_page_settings",
                "table_alias" => "mps",
                "field_name" => "vPageCode",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "Page Code",
                "lang_code" => "STATICPAGES_PAGE_CODE",
                "label_lang" => $this->lang->line('STATICPAGES_PAGE_CODE')
            ),
            "mps_url" => array(
                "name" => "mps_url",
                "table_name" => "mod_page_settings",
                ...
                "type" => "textbox",
                "label" => "Url",
                "lang_code" => "STATICPAGES_URL",
                "label_lang" => $this->lang->line('STATICPAGES_URL')
            ),
            "mps_version" => array(
                "name" => "mps_version",
                "table_name" => "mod_page_settings",
                ...
                "type" => "textbox",
                "label" => "Version",
                "lang_code" => "STATICPAGES_VERSION",
                "label_lang" => $this->lang->line('STATICPAGES_VERSION')
            ),
            "mps_content" => array(
                "name" => "mps_content",
                "table_name" => "mod_page_settings",
                ...
                "type" => "wysiwyg",
                "label" => "Content",
                "lang_code" => "STATICPAGES_CONTENT",
                "label_lang" => $this->lang->line('STATICPAGES_CONTENT')
            ),
            "mps_meta_title" => array(
                "name" => "mps_meta_title",
                "table_name" => "mod_page_settings",
                "table_alias" => "mps",
                "field_name" => "tMetaTitle",
                "entry_type" => "Table",
                "data_type" => "text",
                "show_input" => "Both",
                "type" => "textarea",
                "label" => "Meta Title",
                "lang_code" => "STATICPAGES_META_TITLE",
                "label_lang" => $this->lang->line('STATICPAGES_META_TITLE')
            ),
            "mps_meta_keyword" => array(
                "name" => "mps_meta_keyword",
                "table_name" => "mod_page_settings",
                "table_alias" => "mps",
                "field_name" => "tMetaKeyword",
                "entry_type" => "Table",
                "data_type" => "text",
                "show_input" => "Both",
                "type" => "textarea",
                "label" => "Meta Keyword",
                "lang_code" => "STATICPAGES_META_KEYWORD",
                "label_lang" => $this->lang->line('STATICPAGES_META_KEYWORD')
            ),
            "mps_meta_desc" => array(
                "name" => "mps_meta_desc",
                "table_name" => "mod_page_settings",
                "table_alias" => "mps",
                "field_name" => "tMetaDesc",
                "entry_type" => "Table",
                "data_type" => "text",
                "show_input" => "Both",
                "type" => "textarea",
                "label" => "Meta Desc",
                "lang_code" => "STATICPAGES_META_DESC",
                "label_lang" => $this->lang->line('STATICPAGES_META_DESC')
            ),
            "mps_t_datecreated" => array(
                "name" => "mps_t_datecreated",
                "table_name" => "mod_page_settings",
                "table_alias" => "mps",
                "field_name" => "dtDatecreated",
                "entry_type" => "Table",
                "data_type" => "datetime",
                "show_input" => "Hidden",
                "type" => "date",
                "label" => "T Datecreated",
                "lang_code" => "STATICPAGES_T_DATECREATED",
                "label_lang" => $this->lang->line('STATICPAGES_T_DATECREATED'),
                "format" => 'Y-m-d',
            ),
            "mps_status" => array(
                "name" => "mps_status",
                ...
                "type" => "dropdown",
                "label" => "Status",
                "lang_code" => "STATICPAGES_STATUS",
                "label_lang" => $this->lang->line('STATICPAGES_STATUS'),
                "default" => $this->filter->getDefaultValue("mps_status",
                "Text",
                "Active"),
                "dfapply" => "forceApply",
            )
