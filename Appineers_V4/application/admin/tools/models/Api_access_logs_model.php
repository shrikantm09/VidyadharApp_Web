...
class Api_access_logs_model extends CI_Model 
{
    ...
    public function __construct() 
    {
        ...
        $this->grid_fields = array("u_email", "aa_access_log_id", "aa_api_url", "aa_request_uri", "aa_request_method","aa_excution_time", "aa_error_type", "aa_error_message","aa_i_paddress", "aa_access_date", "sys_custom_field_1", "sys_custom_field_2", "aa_performed_by");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
                ...
                "aa_access_log_id" => array(
                "name" => "aa_access_log_id",
                "table_name" => "api_accesslogs",
                "table_alias" => "aa",
                "field_name" => "iAccessLogId",
                "source_field" => "aa_access_log_id",
                "display_query" => "aa.iAccessLogId",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Log Id",
                "lang_code" => "API_ACCESS_LOGS_ACCESSLOG_ID_BY",
                "label_lang" => $this->lang->line('API_ACCESS_LOGS_ACCESSLOG_ID_BY'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
