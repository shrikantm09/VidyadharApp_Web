 ...
 *
 * @path application\admin\tools\models\State_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class State_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->table_name = "mod_state";
        $this->table_alias = "ms";
        $this->primary_key = "iStateId";
        $this->primary_alias = "ms_state_id";
        ...
        $this->switchto_fields = array(
            $this->db->protect("ms.vState"),
            "' ['",
            $this->db->coalesce($this->db->protect("mc.vCountryCode")
        ), "']'");
        $this->switchto_options = array(
            $this->db->protect("ms.vState")." AS state",
            $this->db->protect("mc.vCountryCode")." AS country_code",
        );
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        {
            $this->db->select("ms.iStateId AS iStateId");
            $this->db->select("ms.iStateId AS ms_state_id");
            $this->db->select("ms.iCountryId AS ms_country_id");
            $this->db->select("ms.vState AS ms_state");
            $this->db->select("ms.vStateCode AS ms_state_code");
            $this->db->select("ms.eStatus AS ms_status");
            $this->db->select("ms.vCountryCode AS ms_country_code");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            "ms_state" => array(
                ...
                "align" => "left",
                "label" => "State",
                "lang_code" => "STATE_STATE",
                "label_lang" => $this->lang->line('STATE_STATE'),
                "width" => 200,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "mc_country" => array(
                ...
                "align" => "left",
                "label" => "Country",
                "lang_code" => "STATE_COUNTRY",
                "label_lang" => $this->lang->line('STATE_COUNTRY'),
                "width" => 200,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "ms_state_code" => array(
                ...
                "table_name" => "mod_state",
                "table_alias" => "ms",
                "field_name" => "vStateCode",
                "source_field" => "ms_state_code",
                "display_query" => "ms.vStateCode",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "State Code",
                "lang_code" => "STATE_STATE_CODE",
                "label_lang" => $this->lang->line('STATE_STATE_CODE'),
                "width" => 150,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "ms_country_code" => array(
                "name" => "ms_country_code",
                "table_name" => "mod_state",
                "table_alias" => "ms",
                "field_name" => "vCountryCode",
                "source_field" => "ms_country_code",
                "display_query" => "ms.vCountryCode",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Country Code",
                "lang_code" => "STATE_COUNTRY_CODE",
                "label_lang" => $this->lang->line('STATE_COUNTRY_CODE'),
                "width" => 150,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "ms_status" => array(
                ...
                "align" => "center",
                "label" => "Status",
                "lang_code" => "STATE_STATUS",
                "label_lang" => $this->lang->line('STATE_STATUS'),
                "width" => 150,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
