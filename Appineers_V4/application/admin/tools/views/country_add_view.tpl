    ...
    <div class="<%$module_name%>" data-form-name="<%$module_name%>">
        <div id="ajax_content_div" class="ajax-content-div top-frm-tab-spacing" >
            ...
            <div id="scrollable_content" class="scrollable-content popup-content top-block-spacing top-frm-block-spacing">
                <!-- Module View Block -->
                <div id="country" class="frm-module-block frm-view-block frm-stand-view">
                                ...
                                <div class="content <%$rl_theme_arr['frm_stand_label_align']%>">
                                    <div class="form-row row-fluid " id="cc_sh_mc_country">
                                        <label class="form-label span3">
                                            <%$form_config['mc_country']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div ">
                                            <span class="frm-data-label"><strong><%$data['mc_country']%></strong></span>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_mc_country_code">
                                        <label class="form-label span3">
                                            <%$form_config['mc_country_code']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div ">
                                            <span class="frm-data-label"><strong><%$data['mc_country_code']%></strong></span>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_mc_country_code_i_s_o_3">
                                        <label class="form-label span3">
                                            <%$form_config['mc_country_code_i_s_o_3']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div ">
                                            <span class="frm-data-label"><strong><%$data['mc_country_code_i_s_o_3']%></strong></span>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_mc_description">
                                        ...
                                        <div class="form-right-div frm-elements-div ">
                                            <span class="frm-data-label"><strong><%$data['mc_description']%></strong></span>
                                        </div>
                                    </div>
