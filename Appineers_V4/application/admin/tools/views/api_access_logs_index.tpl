...
<%javascript%>
    ...
    {
        "name": "aa_access_log_id",
        "label": "<%$list_config['aa_access_log_id']['label_lang']%>"
    },
    {
        "name": "aa_api_url",
    ...
    {
        "name": "aa_access_log_id",
        "index": "aa_access_log_id",
        "label": "<%$list_config['aa_access_log_id']['label_lang']%>",
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['aa_access_log_id']['width']%>",
        "search": <%if $list_config['aa_access_log_id']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['aa_access_log_id']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['aa_access_log_id']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['aa_access_log_id']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['aa_access_log_id']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['aa_access_log_id']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['aa_access_log_id']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "api_access_logs",
                "aria-unique-name": "aa_access_log_id",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['aa_access_log_id']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "api_access_logs",
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['aa_access_log_id']['default']%>",
        "filterSopt": "bw"
    },
    {
        "name": "aa_api_url",
    ...
    },
    {
        ...
        "searchoptions": {
            "attr": {
                ...
                "aria-date-format": "YYYY-MM-DD H:m:s"
            },
            "sopt": dateSearchOpts,
