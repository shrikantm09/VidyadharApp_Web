    ...
    <div class="<%$module_name%>" data-form-name="<%$module_name%>">
        <div id="ajax_content_div" class="ajax-content-div top-frm-spacing" >
            ...
            <div id="scrollable_content" class="scrollable-content top-block-spacing ">
                <!-- Module View Block -->
                <div id="release_notes_details" class="frm-module-block frm-view-block frm-thclm-view">
                            ...
                            <div class="box gradient <%$rl_theme_arr['frm_twclm_content_row']%> <%$rl_theme_arr['frm_twclm_border_view']%>">
                                ...
                                <div class="content two-column-block <%$rl_theme_arr['frm_twclm_label_align']%>">
                                    <div class="column-view-parent form-row row-fluid">
                                        <div class="two-block-view " id="cc_sh_mrnd_release_notes_id"> 
                                            <label class="form-label span3"><%$form_config['mrnd_release_notes_id']['label_lang']%></label>
                                            <div class="form-right-div frm-elements-div " style="width:60%!important">
                                                <strong><%$this->general->displayKeyValueData($data['mrnd_release_notes_id'], $opt_arr['mrnd_release_notes_id'])%></strong>
                                            </div>
                                        </div>
                                        <div class="two-block-view " id="cc_sh_mrnd_version_status"> 
                                            <label class="form-label span3"><%$form_config['mrnd_version_status']['label_lang']%></label>
                                            <div class="form-right-div frm-elements-div " style="width:60%!important">
                                                <strong><%$this->general->displayKeyValueData($data['mrnd_version_status'], $opt_arr['mrnd_version_status'])%></strong>
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="column-view-parent form-row row-fluid">
                                        <div class="two-block-view " id="cc_sh_mrnd_title"> 
                                            <label class="form-label span3"><%$form_config['mrnd_title']['label_lang']%></label>
                                            <div class="form-right-div frm-elements-div " style="width:60%!important">
                                                <strong><%$data['mrnd_title']%></strong>
                                            </div>
                                        </div>
                                        <div class="two-block-view tab-focus-element">&nbsp;</div> 
                                    </div>
                                    <div class="column-view-parent form-row row-fluid">
                                        <div class="two-block-view " id="cc_sh_mrnd_description"> 
                                            <label class="form-label span3"><%$form_config['mrnd_description']['label_lang']%></label>
                                            <div class="form-right-div frm-elements-div  frm-editor-layout" style="width:60%!important">
                                                <strong><%$data['mrnd_description']%></strong>
                                            </div>
                                        </div>
                                        <div class="two-block-view tab-focus-element">&nbsp;</div> 
                                    </div>
