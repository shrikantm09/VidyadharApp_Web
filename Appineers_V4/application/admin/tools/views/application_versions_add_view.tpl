    ...
    <div class="<%$module_name%>" data-form-name="<%$module_name%>">
        <div id="ajax_content_div" class="ajax-content-div <%if $parMod neq ''%>top-frm-tab-spacing<%else%>top-frm-spacing<%/if%>" >
            ...
            <div id="scrollable_content" class="scrollable-content top-block-spacing top-frm-block-spacing">
                <!-- Module View Block -->
                <div id="application_versions" class="frm-module-block frm-view-block frm-stand-view">
                                ...
                                <div class="content <%$rl_theme_arr['frm_stand_label_align']%>">
                                    <div class="form-row row-fluid " id="cc_sh_mav_application_master_id">
                                        ...
                                        <div class="form-right-div frm-elements-div ">
                                            <strong><%$this->general->displayKeyValueData($data['mav_application_master_id'], $opt_arr['mav_application_master_id'])%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_mav_version_name">
                                        ...
                                        <div class="form-right-div frm-elements-div ">
                                            <strong><%$data['mav_version_name']%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_mav_version_number">
                                        ...
                                        <div class="form-right-div frm-elements-div ">
                                            <strong><%$data['mav_version_number']%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_mav_version_type">
                                        ...
                                        <div class="form-right-div frm-elements-div ">
                                            <strong><%$this->general->displayKeyValueData($data['mav_version_type'], $opt_arr['mav_version_type'])%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_mav_application_url">
                                        <label class="form-label span3">
                                            <%$form_config['mav_application_url']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div ">
                                            <strong><%$data['mav_application_url']%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_sys_application_file">
                                        <label class="form-label span3">
                                            <%$form_config['sys_application_file']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div ">
                                    ...
                                    <div class="form-row row-fluid " id="cc_sh_mav_date_published">
                                        <label class="form-label span3">
                                            <%$form_config['mav_date_published']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div  input-append text-append-prepend ">
                                            <strong><%$this->general->dateTimeSystemFormat($data['mav_date_published'])%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_mav_release_notes_id">
                                        ...
                                        <div class="form-right-div frm-elements-div ">
                                            <strong><%$this->general->displayKeyValueData($data['mav_release_notes_id'], $opt_arr['mav_release_notes_id'])%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_mav_status">
                                        <label class="form-label span3">
                                            <%$form_config['mav_status']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div ">
                                            <strong><%$this->general->displayKeyValueData($data['mav_status'], $opt_arr['mav_status'])%></strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
