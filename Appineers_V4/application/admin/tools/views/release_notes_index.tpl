...
<div class="module-list-container">
    <%include file="release_notes_index_strip.tpl"%>
...
<%javascript%>
    ...
    el_grid_settings['default_sort'] = 'mrn_release_date';
    ...
    el_grid_settings['print_rec'] = 'Yes';
    el_grid_settings['print_list'] = 'Yes';
    ...
    },
    {
        ...
        "label": "<%$list_config['mrn_release_date']['label_lang']%>"
    },
    {
        "name": "mrn_release_status",
        "label": "<%$list_config['mrn_release_status']['label_lang']%>"
    },
    {
        "name": "ma_name",
    ...
    },
    {
        ...
        "editrules": {
            ...
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.RELEASE_NOTES_VERSION_NUMBER)
                }
            }
        },
        "searchoptions": {
            "attr": {
                ...
                "aria-module-name": "release_notes",
                "aria-unique-name": "mrn_version_number",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
    ...
    {
        "name": "mrn_release_date",
        "index": "mrn_release_date",
        "label": "<%$list_config['mrn_release_date']['label_lang']%>",
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['mrn_release_date']['width']%>",
        "search": <%if $list_config['mrn_release_date']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['mrn_release_date']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['mrn_release_date']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['mrn_release_date']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['mrn_release_date']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['mrn_release_date']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['mrn_release_date']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "required": true,
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.RELEASE_NOTES_RELEASE_DATE)
                }
            }
        },
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "release_notes",
                "aria-unique-name": "mrn_release_date",
                "autocomplete": "off",
                "class": "search-inline-date",
                "aria-date-format": "<%$this->general->getAdminJSMoments('date')%>"
            },
            "sopt": dateSearchOpts,
            "searchhidden": <%if $list_config['mrn_release_date']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
        ...
        "ctrl_type": "date",
        "default_value": "<%$list_config['mrn_release_date']['default']%>",
        "filterSopt": "bt"
    },
    {
        "name": "mrn_release_status",
        "index": "mrn_release_status",
        "label": "<%$list_config['mrn_release_status']['label_lang']%>",
        "labelClass": "header-align-center",
        "resizable": true,
        "width": "<%$list_config['mrn_release_status']['width']%>",
        "search": <%if $list_config['mrn_release_status']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['mrn_release_status']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['mrn_release_status']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['mrn_release_status']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['mrn_release_status']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['mrn_release_status']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['mrn_release_status']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "center",
        "edittype": "select",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "release_notes",
                "aria-unique-name": "mrn_release_status",
                "autocomplete": "off",
                "data-placeholder": " ",
            ...
            "sopt": intSearchOpts,
            "searchhidden": <%if $list_config['mrn_release_status']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
            "dataUrl": <%if $count_arr["mrn_release_status"]["json"] eq "Yes" %>false<%else%>'<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mrn_release_status&mode=<%$mod_enc_mode["Search"]%>&rformat=html<%$extra_qstr%>'<%/if%>,
            "value": <%if $count_arr["mrn_release_status"]["json"] eq "Yes" %>$.parseJSON('<%$count_arr["mrn_release_status"]["data"]|@addslashes%>')<%else%>null<%/if%>,
            "dataInit": <%if $count_arr['mrn_release_status']['ajax'] eq 'Yes' %>initSearchGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mrn_release_status"]["ajax"] eq "Yes" %>ajax-call<%/if%>',
            "multiple": true
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "release_notes",
            "aria-unique-name": "mrn_release_status",
            "dataUrl": '<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mrn_release_status&mode=<%$mod_enc_mode["Update"]%>&rformat=html<%$extra_qstr%>',
            "dataInit": <%if $count_arr['mrn_release_status']['ajax'] eq 'Yes' %>initEditGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mrn_release_status"] eq "Yes" %>ajax-call<%/if%>',
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'RELEASE_NOTES_RELEASE_STATUS')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
        "default_value": "<%$list_config['mrn_release_status']['default']%>",
        "filterSopt": "in",
        "stype": "select"
    },
    {
        ...
        "editoptions": {
            ...
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'RELEASE_NOTES_ADDED_BY')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
