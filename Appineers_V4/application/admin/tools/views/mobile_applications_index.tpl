...
<div class="module-list-container">
    <%include file="mobile_applications_index_strip.tpl"%>
...
<%javascript%>
    ...
    el_grid_settings['default_sort'] = 'mam_application_name';
    ...
    js_col_name_json = [{
        "name": "mam_application_name",
        "label": "<%$list_config['mam_application_name']['label_lang']%>"
    },
    {
        "name": "mam_device_type",
        "label": "<%$list_config['mam_device_type']['label_lang']%>"
    },
    {
        "name": "ma_name",
    ...
    {
        "name": "mam_status",
        "label": "<%$list_config['mam_status']['label_lang']%>"
    }];
    
    js_col_model_json = [{
        "name": "mam_application_name",
        "index": "mam_application_name",
        "label": "<%$list_config['mam_application_name']['label_lang']%>",
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['mam_application_name']['width']%>",
        "search": <%if $list_config['mam_application_name']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['mam_application_name']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['mam_application_name']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['mam_application_name']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['mam_application_name']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['mam_application_name']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['mam_application_name']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "required": true,
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.MOBILE_APPLICATIONS_APPLICATION_NAME)
                }
            }
        },
        "searchoptions": {
            "attr": {
                ...
                "aria-module-name": "mobile_applications",
                "aria-unique-name": "mam_application_name",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['mam_application_name']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "mobile_applications",
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['mam_application_name']['default']%>",
        "filterSopt": "bw",
    ...
    {
        "name": "mam_device_type",
        "index": "mam_device_type",
        "label": "<%$list_config['mam_device_type']['label_lang']%>",
        "labelClass": "header-align-center",
        "resizable": true,
        "width": "<%$list_config['mam_device_type']['width']%>",
        "search": <%if $list_config['mam_device_type']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['mam_device_type']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['mam_device_type']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['mam_device_type']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['mam_device_type']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['mam_device_type']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['mam_device_type']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "center",
        "edittype": "select",
        "editrules": {
            "required": true,
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.MOBILE_APPLICATIONS_DEVICE_TYPE)
                }
            }
        },
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "mobile_applications",
                "aria-unique-name": "mam_device_type",
                "autocomplete": "off",
                "data-placeholder": " ",
            ...
            "sopt": intSearchOpts,
            "searchhidden": <%if $list_config['mam_device_type']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
            "dataUrl": <%if $count_arr["mam_device_type"]["json"] eq "Yes" %>false<%else%>'<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mam_device_type&mode=<%$mod_enc_mode["Search"]%>&rformat=html<%$extra_qstr%>'<%/if%>,
            "value": <%if $count_arr["mam_device_type"]["json"] eq "Yes" %>$.parseJSON('<%$count_arr["mam_device_type"]["data"]|@addslashes%>')<%else%>null<%/if%>,
            "dataInit": <%if $count_arr['mam_device_type']['ajax'] eq 'Yes' %>initSearchGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mam_device_type"]["ajax"] eq "Yes" %>ajax-call<%/if%>',
            "multiple": true
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "mobile_applications",
            "aria-unique-name": "mam_device_type",
            "dataUrl": '<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mam_device_type&mode=<%$mod_enc_mode["Update"]%>&rformat=html<%$extra_qstr%>',
            "dataInit": <%if $count_arr['mam_device_type']['ajax'] eq 'Yes' %>initEditGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mam_device_type"] eq "Yes" %>ajax-call<%/if%>',
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'MOBILE_APPLICATIONS_DEVICE_TYPE')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
        "default_value": "<%$list_config['mam_device_type']['default']%>",
        "filterSopt": "in",
        "stype": "select"
    },
    {
        ...
        "editoptions": {
            ...
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'MOBILE_APPLICATIONS_ADDED_BY')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
    ...
    },
    {
        ...
        "labelClass": "header-align-center",
        "resizable": true,
        "width": "<%$list_config['mam_status']['width']%>",
        "search": <%if $list_config['mam_status']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['mam_status']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['mam_status']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['mam_status']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['mam_status']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['mam_status']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['mam_status']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "center",
        "edittype": "select",
        "editrules": {
            "required": true,
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.MOBILE_APPLICATIONS_STATUS)
                }
            }
        },
        "searchoptions": {
            ...
            "sopt": intSearchOpts,
            "searchhidden": <%if $list_config['mam_status']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
            "dataUrl": <%if $count_arr["mam_status"]["json"] eq "Yes" %>false<%else%>'<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mam_status&mode=<%$mod_enc_mode["Search"]%>&rformat=html<%$extra_qstr%>'<%/if%>,
            "value": <%if $count_arr["mam_status"]["json"] eq "Yes" %>$.parseJSON('<%$count_arr["mam_status"]["data"]|@addslashes%>')<%else%>null<%/if%>,
            "dataInit": <%if $count_arr['mam_status']['ajax'] eq 'Yes' %>initSearchGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mam_status"]["ajax"] eq "Yes" %>ajax-call<%/if%>',
            "multiple": true
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "mobile_applications",
            "aria-unique-name": "mam_status",
            "dataUrl": '<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=mam_status&mode=<%$mod_enc_mode["Update"]%>&rformat=html<%$extra_qstr%>',
            "dataInit": <%if $count_arr['mam_status']['ajax'] eq 'Yes' %>initEditGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["mam_status"] eq "Yes" %>ajax-call<%/if%>',
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'MOBILE_APPLICATIONS_STATUS')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
        "default_value": "<%$list_config['mam_status']['default']%>",
        "filterSopt": "in",
        "stype": "select"
    }];
