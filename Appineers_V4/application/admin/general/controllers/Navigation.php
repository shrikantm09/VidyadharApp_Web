...
class Navigation extends Cit_Controller
{
    ...
    public function index()
    {
        ...
        $data_log_arr['fifteenyminutes'] = "The Past 15 Minutes";
        $data_log_arr['thirtyminutes'] = "The Past 30 Minutes";
        $data_log_arr['onehour'] = "The past hour";
        ...
        $data_flush_arr['fifteenyminutes'] = "the past 15 minutes";
        $data_flush_arr['thirtyminutes'] = "the past 30 minutes";
        ...
        switch ($range) {
            case 'fifteenyminutes' :
                $time_stamp_flush = date("Y-m-d H:i:s", strtotime('-15 minutes'));
                $curr_date = date("Y-m-d H:i:s");
                $extra_cond_flush = " AND dTimeStamp < " . $this->db->escape($curr_date) . " AND dTimeStamp > " . $this->db->escape($time_stamp_flush);
                break;
            case 'thirtyminutes' :
                    $time_stamp_flush = date("Y-m-d H:i:s", strtotime('-30 minutes'));
                    $curr_date = date("Y-m-d H:i:s");
                    $extra_cond_flush = " AND dTimeStamp < " . $this->db->escape($curr_date) . " AND dTimeStamp > " . $this->db->escape($time_stamp_flush);
                    break;
            case 'onehour' :
