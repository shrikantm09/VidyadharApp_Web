 ...
 * 
 * @class Db_log_model.php
 * 
 * @path application\admin\general\models\Db_log_model.php
 * 
 * @version 4.0
 * 
 * @author CIT Dev Team
 ...
 * @since 01.08.2016
 */
class Db_log_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->main_table = "mod_db_changelog";
        $this->table_alias = 'mdb';
