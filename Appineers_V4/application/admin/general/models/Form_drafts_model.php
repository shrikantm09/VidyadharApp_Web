...
/**
 * Description of Form Drafts Model
 *
 * @category admin
 * 
 * @package general
 ...
 * @subpackage models
 *  
 * @module FormSaveDraft
 * 
 * @class Form_drafts_model
 * 
 * @path application\admin\general\models\Form_drafts_model.php
 * 
 * @version 4.0
 * 
 * @author CIT Dev Team
 ...
 * @since 01.08.2016
 */
class Form_drafts_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->main_table = "mod_form_drafts";
        $this->table_alias = 'mfd';
        $this->primary_key = "iFormDraftsId";
    }
