 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'CIT');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'CIT');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'CIT MODULE DATA');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by CIT - www.configure.it");

/**
 * Title.
 */
define ('PDF_TITLE', 'CIT DATA RECORDS');


/**
 * Subject.
 */
define ('PDF_SUBJECT', 'CIT DATA RECORDS');

/**
 * Keywords
 */
define ('PDF_KEYWORDS', 'PDF, CIT, MODULE, DATA, RECORDS,');
