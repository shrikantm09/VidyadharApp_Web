...
EOD;
    ...
    public function apiLogger($input_params = array(), $e = NULL)
    {
        ...
        $this->changePasswordValue($input_params);
    ...
    public function changePasswordValue($original =array(), $replace= array()){
        ...
        foreach( $original as $key => $val){
            ...
            $original['password'] = array_key_exists("password", $original) ? "******" : "";
            $original['old_password'] = array_key_exists("old_password", $original) ? "******" : "";
            $original['new_password'] = array_key_exists("new_password", $original) ? "******" : "";
            $original['confirm_password'] = array_key_exists("confirm_password", $original) ? "******" : "";
            $original['old_password'] = array_key_exists("old_password", $original) ? "******" : "";
