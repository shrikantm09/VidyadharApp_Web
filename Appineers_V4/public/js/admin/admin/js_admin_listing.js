...
function getRangePickerQuickList() {
    var defaultList = [
        ...
        {
            'key': 'Last 15 Minutes',
            'label': js_lang_label.GENERIC_GRID_15_MINUTES,
            'value': [moment.utc(moment().subtract('minutes', 15)), moment.utc(moment())]
        },
        {
            'key': 'Last 30 Minutes',
            'label': js_lang_label.GENERIC_GRID_30_MINUTES,
            'value': [moment.utc(moment().subtract('minutes', 30)), moment.utc(moment())]
        },
        {
            'key': 'Last 1 Hours',
            'label': js_lang_label.GENERIC_GRID_ONE_HOURS,
            'value': [moment.utc(moment().subtract('hours', 1)), moment.utc(moment())]
         },
