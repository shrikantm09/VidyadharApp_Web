...
(function(tinymce) {
	...
	tinymce.documentBaseURL = site_url+'public/js/libraries/tiny_mce/';
...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			DOM.get(t.id).style.visibility = 'hidden';
            DOM.get(t.id).style.height = '0';
            DOM.get(t.id).style.position = 'absolute';
